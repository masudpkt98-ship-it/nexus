...
export const kpiTypes = ["Strategis", "Teknis", "Generik", "Project", "Mandatory"] as const;
...
export interface DictionaryCompetency {
  ...
  keyActions?: string[]; // Perilaku Utama / Key Actions (behavioral dict; no per-level scale)
