...
// In-card labels & badges for the Strategic Planning module, aligned to STRATEGY_KEYS.
// SWOT category names appear both plural (card badges) and singular (modal dropdown).
const STRATEGY_KEYS = [
  "Vision", "Mission", "Milestones",
  "Strengths", "Weaknesses", "Opportunities", "Threats",
  "Internal · positive", "Internal · negative", "External · positive", "External · negative",
  "Edit", "Cancel", "Create", "Save", "New Objective", "New Goal",
  "No core values yet. Add one.", "No strategic goals yet. Add one.", "No items yet.",
  "Edit Vision & Mission", "New Core Value", "Edit Core Value",
  "New Strategic Goal", "Edit Strategic Goal", "New SWOT Item", "Edit SWOT Item", "Edit Objective",
  "Value", "Description", "Goal", "Target", "Owner", "Objective", "Quarter", "Progress (%)",
  "Category", "Item", "Owner is set to you when created.", "You",
  "Strength", "Weakness", "Opportunity", "Threat",
] as const;

const STRATEGY_TR: Record<Exclude<Lang, "en">, string[]> = {
  id: ["Visi", "Misi", "Milestone", "Kekuatan", "Kelemahan", "Peluang", "Ancaman", "Internal · positif", "Internal · negatif", "Eksternal · positif", "Eksternal · negatif", "Edit", "Batal", "Buat", "Simpan", "Objektif Baru", "Sasaran Baru", "Belum ada nilai inti. Tambahkan satu.", "Belum ada sasaran strategis. Tambahkan satu.", "Belum ada item.", "Edit Visi & Misi", "Nilai Inti Baru", "Edit Nilai Inti", "Sasaran Strategis Baru", "Edit Sasaran Strategis", "Item SWOT Baru", "Edit Item SWOT", "Edit Objektif", "Nilai", "Deskripsi", "Sasaran", "Target", "Pemilik", "Objektif", "Kuartal", "Progres (%)", "Kategori", "Item", "Pemilik diatur ke Anda saat dibuat.", "Anda", "Kekuatan", "Kelemahan", "Peluang", "Ancaman"],
  zh: ["愿景", "使命", "里程碑", "优势", "劣势", "机会", "威胁", "内部 · 正面", "内部 · 负面", "外部 · 正面", "外部 · 负面", "编辑", "取消", "创建", "保存", "新建目标", "新建战略目标", "暂无核心价值观。添加一个。", "暂无战略目标。添加一个。", "暂无条目。", "编辑愿景与使命", "新建核心价值观", "编辑核心价值观", "新建战略目标", "编辑战略目标", "新建 SWOT 条目", "编辑 SWOT 条目", "编辑目标", "价值观", "描述", "目标", "目标值", "负责人", "目标", "季度", "进度 (%)", "类别", "条目", "创建时负责人默认为您。", "您", "优势", "劣势", "机会", "威胁"],
  ru: ["Видение", "Миссия", "Вехи", "Сильные стороны", "Слабые стороны", "Возможности", "Угрозы", "Внутренние · плюс", "Внутренние · минус", "Внешние · плюс", "Внешние · минус", "Изменить", "Отмена", "Создать", "Сохранить", "Новая цель", "Новая стратегическая цель", "Пока нет ценностей. Добавьте.", "Пока нет стратегических целей. Добавьте.", "Пока нет элементов.", "Изменить видение и миссию", "Новая ценность", "Изменить ценность", "Новая стратегическая цель", "Изменить стратегическую цель", "Новый элемент SWOT", "Изменить элемент SWOT", "Изменить цель", "Ценность", "Описание", "Цель", "Целевой показатель", "Владелец", "Цель", "Квартал", "Прогресс (%)", "Категория", "Элемент", "Владелец назначается вам при создании.", "Вы", "Сильная сторона", "Слабая сторона", "Возможность", "Угроза"],
  fr: ["Vision", "Mission", "Jalons", "Forces", "Faiblesses", "Opportunités", "Menaces", "Interne · positif", "Interne · négatif", "Externe · positif", "Externe · négatif", "Modifier", "Annuler", "Créer", "Enregistrer", "Nouvel objectif", "Nouveau but", "Aucune valeur pour l'instant. Ajoutez-en une.", "Aucun but stratégique pour l'instant. Ajoutez-en un.", "Aucun élément pour l'instant.", "Modifier vision et mission", "Nouvelle valeur", "Modifier la valeur", "Nouveau but stratégique", "Modifier le but stratégique", "Nouvel élément SWOT", "Modifier l'élément SWOT", "Modifier l'objectif", "Valeur", "Description", "But", "Cible", "Responsable", "Objectif", "Trimestre", "Progression (%)", "Catégorie", "Élément", "Le responsable vous est attribué à la création.", "Vous", "Force", "Faiblesse", "Opportunité", "Menace"],
  es: ["Visión", "Misión", "Hitos", "Fortalezas", "Debilidades", "Oportunidades", "Amenazas", "Interno · positivo", "Interno · negativo", "Externo · positivo", "Externo · negativo", "Editar", "Cancelar", "Crear", "Guardar", "Nuevo objetivo", "Nueva meta", "Aún no hay valores. Agrega uno.", "Aún no hay metas estratégicas. Agrega una.", "Aún no hay elementos.", "Editar visión y misión", "Nuevo valor", "Editar valor", "Nueva meta estratégica", "Editar meta estratégica", "Nuevo elemento SWOT", "Editar elemento SWOT", "Editar objetivo", "Valor", "Descripción", "Meta", "Objetivo", "Responsable", "Objetivo", "Trimestre", "Progreso (%)", "Categoría", "Elemento", "El responsable se te asigna al crear.", "Tú", "Fortaleza", "Debilidad", "Oportunidad", "Amenaza"],
  ar: ["الرؤية", "الرسالة", "المعالم", "نقاط القوة", "نقاط الضعف", "الفرص", "التهديدات", "داخلي · إيجابي", "داخلي · سلبي", "خارجي · إيجابي", "خارجي · سلبي", "تعديل", "إلغاء", "إنشاء", "حفظ", "هدف جديد", "هدف استراتيجي جديد", "لا توجد قيم بعد. أضف واحدة.", "لا توجد أهداف استراتيجية بعد. أضف واحدًا.", "لا توجد عناصر بعد.", "تعديل الرؤية والرسالة", "قيمة أساسية جديدة", "تعديل القيمة الأساسية", "هدف استراتيجي جديد", "تعديل الهدف الاستراتيجي", "عنصر SWOT جديد", "تعديل عنصر SWOT", "تعديل الهدف", "القيمة", "الوصف", "الهدف", "المستهدف", "المالك", "الهدف", "الربع", "التقدم (%)", "الفئة", "العنصر", "يتم تعيينك كمالك عند الإنشاء.", "أنت", "نقطة قوة", "نقطة ضعف", "فرصة", "تهديد"],
  bn: ["ভিশন", "মিশন", "মাইলফলক", "শক্তি", "দুর্বলতা", "সুযোগ", "হুমকি", "অভ্যন্তরীণ · ইতিবাচক", "অভ্যন্তরীণ · নেতিবাচক", "বাহ্যিক · ইতিবাচক", "বাহ্যিক · নেতিবাচক", "সম্পাদনা", "বাতিল", "তৈরি করুন", "সংরক্ষণ", "নতুন উদ্দেশ্য", "নতুন কৌশলগত লক্ষ্য", "এখনও কোনো মূল মূল্যবোধ নেই। একটি যোগ করুন।", "এখনও কোনো কৌশলগত লক্ষ্য নেই। একটি যোগ করুন।", "এখনও কোনো আইটেম নেই।", "ভিশন ও মিশন সম্পাদনা", "নতুন মূল মূল্যবোধ", "মূল মূল্যবোধ সম্পাদনা", "নতুন কৌশলগত লক্ষ্য", "কৌশলগত লক্ষ্য সম্পাদনা", "নতুন SWOT আইটেম", "SWOT আইটেম সম্পাদনা", "উদ্দেশ্য সম্পাদনা", "মূল্যবোধ", "বিবরণ", "লক্ষ্য", "টার্গেট", "মালিক", "উদ্দেশ্য", "ত্রৈমাসিক", "অগ্রগতি (%)", "বিভাগ", "আইটেম", "তৈরি করার সময় মালিক আপনাকে নির্ধারণ করা হয়।", "আপনি", "শক্তি", "দুর্বলতা", "সুযোগ", "হুমকি"],
  hi: ["विज़न", "मिशन", "माइलस्टोन", "ताकत", "कमजोरियां", "अवसर", "खतरे", "आंतरिक · सकारात्मक", "आंतरिक · नकारात्मक", "बाहरी · सकारात्मक", "बाहरी · नकारात्मक", "संपादित करें", "रद्द करें", "बनाएं", "सहेजें", "नया उद्देश्य", "नया रणनीतिक लक्ष्य", "अभी तक कोई मूल मूल्य नहीं। एक जोड़ें।", "अभी तक कोई रणनीतिक लक्ष्य नहीं। एक जोड़ें।", "अभी तक कोई आइटम नहीं।", "विज़न और मिशन संपादित करें", "नया मूल मूल्य", "मूल मूल्य संपादित करें", "नया रणनीतिक लक्ष्य", "रणनीतिक लक्ष्य संपादित करें", "नया SWOT आइटम", "SWOT आइटम संपादित करें", "उद्देश्य संपादित करें", "मूल्य", "विवरण", "लक्ष्य", "टारगेट", "स्वामी", "उद्देश्य", "तिमाही", "प्रगति (%)", "श्रेणी", "आइटम", "बनाने पर स्वामी आपको सौंपा जाता है।", "आप", "ताकत", "कमजोरी", "अवसर", "खतरा"],
  ur: ["ویژن", "مشن", "سنگ میل", "طاقتیں", "کمزوریاں", "مواقع", "خطرات", "اندرونی · مثبت", "اندرونی · منفی", "بیرونی · مثبت", "بیرونی · منفی", "ترمیم", "منسوخ", "بنائیں", "محفوظ کریں", "نیا مقصد", "نیا اسٹریٹجک ہدف", "ابھی کوئی بنیادی اقدار نہیں۔ ایک شامل کریں۔", "ابھی کوئی اسٹریٹجک اہداف نہیں۔ ایک شامل کریں۔", "ابھی کوئی آئٹم نہیں۔", "ویژن اور مشن میں ترمیم", "نئی بنیادی قدر", "بنیادی قدر میں ترمیم", "نیا اسٹریٹجک ہدف", "اسٹریٹجک ہدف میں ترمیم", "نیا SWOT آئٹم", "SWOT آئٹم میں ترمیم", "مقصد میں ترمیم", "قدر", "تفصیل", "ہدف", "ٹارگٹ", "مالک", "مقصد", "سہ ماہی", "پیش رفت (%)", "زمرہ", "آئٹم", "بناتے وقت مالک آپ کو تفویض کیا جاتا ہے۔", "آپ", "طاقت", "کمزوری", "موقع", "خطرہ"],
  ko: ["비전", "미션", "마일스톤", "강점", "약점", "기회", "위협", "내부 · 긍정", "내부 · 부정", "외부 · 긍정", "외부 · 부정", "편집", "취소", "생성", "저장", "새 목표", "새 전략 목표", "핵심 가치가 아직 없습니다. 추가하세요.", "전략 목표가 아직 없습니다. 추가하세요.", "항목이 아직 없습니다.", "비전 및 미션 편집", "새 핵심 가치", "핵심 가치 편집", "새 전략 목표", "전략 목표 편집", "새 SWOT 항목", "SWOT 항목 편집", "목표 편집", "가치", "설명", "목표", "목표치", "담당자", "목표", "분기", "진행률 (%)", "카테고리", "항목", "생성 시 담당자가 본인으로 설정됩니다.", "나", "강점", "약점", "기회", "위협"],
  ja: ["ビジョン", "ミッション", "マイルストーン", "強み", "弱み", "機会", "脅威", "内部 · ポジティブ", "内部 · ネガティブ", "外部 · ポジティブ", "外部 · ネガティブ", "編集", "キャンセル", "作成", "保存", "新規目標", "新規戦略目標", "コアバリューがまだありません。追加してください。", "戦略目標がまだありません。追加してください。", "項目がまだありません。", "ビジョンとミッションを編集", "新規コアバリュー", "コアバリューを編集", "新規戦略目標", "戦略目標を編集", "新規 SWOT 項目", "SWOT 項目を編集", "目標を編集", "バリュー", "説明", "目標", "ターゲット", "オーナー", "目標", "四半期", "進捗 (%)", "カテゴリ", "項目", "作成時にオーナーはあなたに設定されます。", "あなた", "強み", "弱み", "機会", "脅威"],
  pt: ["Visão", "Missão", "Marcos", "Forças", "Fraquezas", "Oportunidades", "Ameaças", "Interno · positivo", "Interno · negativo", "Externo · positivo", "Externo · negativo", "Editar", "Cancelar", "Criar", "Salvar", "Novo objetivo", "Nova meta", "Ainda não há valores. Adicione um.", "Ainda não há metas estratégicas. Adicione uma.", "Ainda não há itens.", "Editar visão e missão", "Novo valor", "Editar valor", "Nova meta estratégica", "Editar meta estratégica", "Novo item SWOT", "Editar item SWOT", "Editar objetivo", "Valor", "Descrição", "Meta", "Alvo", "Responsável", "Objetivo", "Trimestre", "Progresso (%)", "Categoria", "Item", "O responsável é você ao criar.", "Você", "Força", "Fraqueza", "Oportunidade", "Ameaça"],
};
...
for (const [code, values] of Object.entries(TRANSLATIONS)) {
  ...
  STRATEGY_KEYS.forEach((key, i) => (map[key] = STRATEGY_TR[c][i]));
